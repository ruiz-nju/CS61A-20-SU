...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    difference_in_the_one_digits = abs(player_score % 10 - opponent_score % 10)
    if difference_in_the_one_digits == (opponent_score // 10) % 10:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    pre_score_0, pre_score_1 = 0, 0
    while score0 < goal and score1 < goal:
        if who == 0:
            num_of_turns = strategy0(score0, score1)
            new_score = take_turn(num_of_turns, score1, dice)
            score0 += new_score
            if feral_hogs:
                if abs(num_of_turns - pre_score_0) == 2:
                    score0 += 3
                pre_score_0 = new_score
            if is_swap(score0, score1):
                score0, score1 = score1, score0
        else:
            num_of_turns = strategy1(score1, score0)
            new_score = take_turn(num_of_turns, score0, dice)
            score1 += new_score
            if feral_hogs:
                if abs(num_of_turns - pre_score_1) == 2:
                    score1 += 3
                pre_score_1 = new_score
